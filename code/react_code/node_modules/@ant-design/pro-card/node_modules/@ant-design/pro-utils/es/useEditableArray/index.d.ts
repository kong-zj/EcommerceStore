 ...
 * @param action
 */
export declare function editableRowByKey<RecordType>(params: {
    data: RecordType[];
 ...
 */
export declare function SaveEditableAction<T>({ recordKey, onSave, form, row, children, newLineConfig, editorType, tableName, }: ActionRenderConfig<T> & {
    row: any;
    children: any;
}): JSX.Element;
/**
...
declare function useEditableArray<RecordType>(props: RowEditableConfig<RecordType> & {
    ...
    cancelEditable: (recordKey: RecordKey, needReTry?: boolean | undefined) => true | undefined;
